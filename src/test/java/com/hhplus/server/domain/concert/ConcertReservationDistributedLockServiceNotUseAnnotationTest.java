...
class ConcertReservationDistributedLockServiceNotUseAnnotationTest {
    ...
    void givenAvailableConcertSeat_whenReservationSeat_thenTemporalReservationSuccess() throws InterruptedException {
        ...
        // when
        ReservationInfo reservationInfoResult = concertService.findConcertSeatForReservationWithDistributedLockNotUseAnnotation(user, concertId, scheduleId, temporaryReservedSeat.getSeatId());
    ...
    void givenAvailableConcertSeat_whenReservationSeat_thenDistributedLockAcquisitionFailsAndThrowException() throws InterruptedException {
        ...
        assertThrows(CommonException.class, () ->
                concertService.findConcertSeatForReservationWithDistributedLockNotUseAnnotation(user, concertId, scheduleId, concertSeatId));
    }
    ...
    void givenNotExistConcertSeat_whenReservationSeat_thenSeatNotFoundAndThrowException() throws InterruptedException {
        ...
        // when & then
        assertThrows(CommonException.class, () -> concertService.findConcertSeatForReservationWithDistributedLockNotUseAnnotation(user, concertId, scheduleId, notExistConcertSeatId));
        verify(lock).unlock();
    }
    ...
    void givenExistConcertSeat_whenReservationConcertSeat_thenInterruptedDuringLockAcquisitionAndThrowException() throws InterruptedException {
        ...
        // when & then
        assertThrows(CommonException.class, () -> concertService.findConcertSeatForReservationWithDistributedLockNotUseAnnotation(user, concertId, scheduleId, concertSeatId));
    }
